                            ...
                            <div style="text-align:center;">
                                <ul class="pagination">
                                    <c:if test="${!pagehelper.isFirstPage}">                                        
                                        <li>
                                            <a href="findDishInCanteen.action?pageNum=1&pageSize=${pagehelper.pageSize}">首页</a>
                                        </li>
                                        <li>
                                    ...
                                    <c:if test="${!pagehelper.isLastPage}">
                                        ...
                                        <li>
                                            <a href="findDishInCanteen.action?pageNum=${pagehelper.pages}&pageSize=${pagehelper.pageSize}">尾页</a>
                                        </li>
                                    </c:if>
                                </ul>
                            </div>
